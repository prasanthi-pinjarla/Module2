package com.cg.crud.controller;
...
import com.cg.crud.service.IEmployeeService;
...
public class MyController {
	...
	public ModelAndView employeeSearch(@RequestParam("eid") int id){
		...
		return new ModelAndView("search","emp", employee);
		
	}
	
    @RequestMapping(value="doupdatesearch",method=RequestMethod.GET)
    public ModelAndView updateSearch(@RequestParam("empId")int id,@ModelAttribute("my1")Employee emp,Map<String,Object> model){
           ...
           if(emp1 != null){
                  ...
                  myDeg.add("Manager");
                  model.put("deg",myDeg);
                  return new ModelAndView("updateform","temp", emp1);
           }else{
                  return new ModelAndView("updateerror");
           }
    ...
    Employee emp,BindingResult result,
           ...
           if(res == true){
                  return new ModelAndView("updateSuccess","edata", emp);
           }else{
                  return new ModelAndView("updaterror");
           }
